...
class For(Statement):
    ...
    """
    def __init__(self, init: Statement, cond: Expression, update: Statement, body: Statement) -> None:
        super().__init__("for")
        self.init = init
        self.cond = cond
        self.update = update
...
class Call(Expression):
    ...
    def __init__(self, ident: Identifier, argument_list: ExpressionList) -> None:
        super().__init__("call")
        self.ident = ident
